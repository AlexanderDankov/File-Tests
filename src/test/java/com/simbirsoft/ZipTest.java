...
public class ZipTest {
    ...
    public void zipTestWithPassword() throws Exception {
        File zipSource = new File("src/test/resources/zip_2MB.zip");
        try(InputStream is = new FileInputStream(zipSource)) {
            ...
            Assertions.assertAll(
                    ...
                    () -> assertThat(fileNames.get(0)).isEqualTo("file_example_ODS_5000.ods"),
                    () -> assertThat(fileNames.get(1)).isEqualTo("file_example_PPT_1MB.ppt"),
                    () -> assertThat(fileNames.get(2)).isEqualTo("file-sample_1MB.doc"),
                    () -> assertThat(fileNames.get(3)).isEqualTo("sample.pdf"),
                    () -> assertThat(fileNames.get(4)).isEqualTo("SampleText.txt")
            );
        }
    }
}
